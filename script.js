...
- Tienes disponibles las herramientas "generar_imagen" y "generar_documento". Úsalas cuando realmente ayuden (un diagrama, una foto ilustrativa de un componente, o un reporte/documento que el usuario pidió) en vez de decir que no puedes generar ese tipo de contenido.`;
